...
//			ImageIcon pressedIcon = ImageUtils.loadImageAsIcon(4*tileLength, 3*tileLength, "./Assets/ArrowButton/ArrowButtonPressed.png");
//			ImageIcon releasedIcon = ImageUtils.loadImageAsIcon(4*tileLength, 3*tileLength, "./Assets/ArrowButton/ArrowButton.png");
//			
...
//		pointTile1.setIcon(ImageUtils.loadImageAsIcon(path));
//	}
//	
//	/**
...
//		}
//		String path = "Assets/Point_tiles/Xp.jpg".replaceAll("X", Integer.valueOf(points).toString());
//		pointTile2.setIcon(ImageUtils.loadImageAsIcon(path));
//	}
//
//	/**
